...
describe('AmqplibClientAdapter E2E Tests', () => {
    ...
    describe('connection management', () => {
        it('should connect successfully to RabbitMQ', async () => {
            const client = new AmqplibClientAdapter(validConfig);
        ...
        it('should throw RunMQException on invalid connection', async () => {
            const client = new AmqplibClientAdapter(invalidConfig);
    ...
    describe('channel management', () => {
        ...
        it('should return the same default channel on repeated calls', async () => {
            const client = new AmqplibClientAdapter(validConfig);
            await client.connect();
            const defaultChannel1 = await client.getDefaultChannel();
            const defaultChannel2 = await client.getDefaultChannel();
            expect(defaultChannel1).toBe(defaultChannel2);
            await client.disconnect();
        });
    });
});
